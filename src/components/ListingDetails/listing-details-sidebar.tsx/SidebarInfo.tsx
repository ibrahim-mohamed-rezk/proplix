  ...
  return (
    <>
      ...
      <div className="text-center mt-25">
        ...
        <div className="flex property?s-center mt-[10px] justify-center gap-[10px]">
          <a
        ...
        {showPhoneNumber && property?.user?.phone && (
          <div className="mt-2 text-center">
            <a
              href={`tel:${property.user.phone}`}
              className="text-[#FF6625] font-medium hover:underline"
            >
              {property.user.phone}
            </a>
          </div>
