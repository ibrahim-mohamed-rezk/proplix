       ...
       <div className="position-relative">
           ...
           <div className="row">
             {dashboard_card_data.map((item) => (
               <div key={item.id} className="col-lg-3 col-6">
                 <div
                   className={`dash-card-one bg-white       position-relative mb-15 ${item.class_name}`}
                 >
         ...
         <div className="row gx-xxl-5 d-flex pt-15 lg-pt-10">
           <div className="col-xl-7 col-lg-6 d-flex flex-column">
             <div className="user-activity-chart bg-white   mt-30 h-100">
           ...
           <div className="col-xl-5 col-lg-6 d-flex">
             <div className="recent-job-tab bg-white   mt-30 plr w-100">
