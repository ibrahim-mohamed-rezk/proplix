       ...
       <div className="position-relative">
         ...
         >
           ...
           >
             ...
             <path
               ...
               fill="#231F20"
             />
             <path d="M171.101 10H165.585V41.6367H171.101V10Z" fill="#231F20" />
             <path
               d="M181.634 18.9051H176.118V41.6433H181.634V18.9051Z"
               fill="#231F20"
             />
         ...
         <nav className="dasboard-main-nav pt-30 pb-30 bottom-line">
           <ul className="style-none">
             <li className="plr">
               <Link
                 href={`/${lang}/dashboard/dashboard-index`}
             ...
             <li className="plr">
               <Link
                 href={`/${lang}/dashboard/account-settings`}
                 className={`d-flex w-100 align-items-center ${
                   isRTL ? "flex-row-reverse" : ""
                 } ${
             ...
             <li className="plr">
               <Link
                 href={`/${lang}/dashboard/properties-list`}
                 className={`d-flex w-100 align-items-center ${
                   isRTL ? "flex-row-reverse" : ""
                 } ${
             ...
             <li className="plr">
               <Link
                 href={`/${lang}/dashboard/add-property`}
                 className={`d-flex w-100 align-items-center ${
                   isRTL ? "flex-row-reverse" : ""
         ...
         <div className="plr mt-4" onClick={logout}>
           <Link
             ...
             className={`d-flex ${
               isRTL ? "flex-row-reverse" : ""
             } w-100 align-items-center logout-btn`}
           >
